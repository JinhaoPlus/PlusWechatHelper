package top.jinhaoplus.wechathelper.wechat.message.models.passive.receive;

import top.jinhaoplus.wechathelper.wechat.message.models.passive.receive.event.*;
...
public class ReceiveEventMessage extends ReceiveMessage {
    ...
    public static Class<? extends ReceiveEventMessage> getEventClass(String messageStr, ReceiveEventMessage receiveEventMessage) {
        ...
        } else if (ReceiveEventType.MASSSENDJOBFINISH.equals(receiveEventMessage.getEvent())) {
            return ReceiveMassSendJobFinishEventMessage.class;
        } else
